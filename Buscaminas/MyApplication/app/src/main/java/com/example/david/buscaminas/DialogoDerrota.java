...
public class DialogoDerrota extends DialogFragment {

    //Instancia de la interfaz
    RespuestaDialogoDerrota respuesta;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle("HAS EXPLOTADO UNA BOMBA, HAS PERDIDO");
     ...
     */
    public interface RespuestaDialogoDerrota{
    ...
    public void onAttach(Activity activity) {
        ...
        respuesta=(RespuestaDialogoDerrota) activity;
    }
