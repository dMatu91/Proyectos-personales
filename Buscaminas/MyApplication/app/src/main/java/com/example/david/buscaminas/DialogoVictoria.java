...
public class DialogoVictoria extends DialogFragment {


    //Instancia de la interfaz
    DialogoVictoria.RespuestaVictoria respuesta;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle("YA NO HAY MAS MINAS, HAS GANADO");
     ...
     */
    public interface RespuestaVictoria{
    ...
    public void onAttach(Activity activity) {
        ...
        respuesta=(DialogoVictoria.RespuestaVictoria) activity;
    }
