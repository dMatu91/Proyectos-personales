...
<title>Tiempo Comarcas Euskera</title>
			...
			var infowindow = new google.maps.InfoWindow({content:'hola'});
				...
				<?php
					...
					for ($i = 0; $i < 10; $i++) {
						...
						$desc=$leido->areaForecast[$cont]->periodDataList->periodData->areaForecastData->windIcon->descriptions->eu;
						$desc=$desc."<br>".$leido->areaForecast[$cont]->periodDataList->periodData->areaForecastData->weatherIcon->descriptions->eu;
						$desc=$desc."<br>".$leido->areaForecast[$cont]->periodDataList->periodData->areaForecastData->tempIcon->descriptions->eu;
						...
						$lugar=$leido->areaForecast[$cont]->areaName->eu;
...
<!-- #header -->
	<div id="header">
		<div id="mainMenu">
			<ul id="navlist">
				<li id="active"><a href="#">Eskualdeka Denbora</a></li>
				<li><a href="tiempoCiudadesEuskera.php">Hiri Garaia</a></li>
			</ul>
		</div>
		<div id="logo">Denbora Euskadi</div>
		<div id="author"><a href="tiempoComarcas.php"><img src="images/espanola.png" alt="" width="28" height="15" /> Español</a></div>
...
<!-- #sidebar1 -->
	<div id="sidebar1">
		...
		<div>
			<div class="title"><img src="images/pTitle.gif" alt="" width="25" height="25" /><h2>Euskal Eskualdeetan</h2></div>
			<ul>
				<li> Kostaldea
				</li>
				<li> Airaldea
				</li>
				<li> Kantauriko Mendiak
				</li>
				<li> Barnealdeko Arroak
				</li>
				<li> Hegoaldeko Mendiak
				</li>
				<li> Ebro Bailara
				</li>
				<li> Pirinioak
